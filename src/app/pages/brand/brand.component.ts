...
@Component({
  ...
  template: `
    <main class="container">
      <app-header />
      <section class="flex md:h-[70vh] md:w-2/5">
        <article
        ...
        >
          <span
            class="bg-secondary to-secondary from-secondary-dark absolute inset-0 rounded-t-full opacity-85 md:rounded-t-none md:rounded-bl-3xl md:bg-gradient-to-r"
          ></span>
          <figure
